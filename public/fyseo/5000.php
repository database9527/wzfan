...
//------------------这个文件是输出详细蜘蛛访问地址的文件 我把它当成D区代码-------------------------------
		...
		'name'=>'全部',
		'count'=>$zongs,
		'url'=>"/kkmp326/5000.php?zong--$zhizhutimes--p--1"
		],
		[
		'key'=>'Baiduspider',
		'name'=>'百度',
		'count'=>$baiduspidersa,
		'url'=>"/kkmp326/5000.php?Baiduspider--$zhizhutimes--p--1"
		],
		[
		'key'=>'googlebot',
		'name'=>'Google',
		'count'=>$Googlebotsa,
		'url'=>"/kkmp326/5000.php?Googlebot--$zhizhutimes--p--1"
		],
		[
		'key'=>'Sogou',
		'name'=>'搜狗',
		'count'=>$Sogouspidersa,
		'url'=>"/kkmp326/5000.php?Sogou--$zhizhutimes--p--1"
		],
		[
		'key'=>'360Spider',
		'name'=>'360蜘蛛',
		'count'=>$liuSpidersa,
		'url'=>"/kkmp326/5000.php?360Spider--$zhizhutimes--p--1"
		],
		[
		'key'=>'Yisouspider',
		'name'=>'神马',
		'count'=>$Yisouspidersa,
		'url'=>"/kkmp326/5000.php?Yisouspider--$zhizhutimes--p--1"
		],
		[
		'key'=>'Bytespider',
		'name'=>'今日头条',
		'count'=>$Bytespidersa,
		'url'=>"/kkmp326/5000.php?Bytespider--$zhizhutimes--p--1"
		]
		];
